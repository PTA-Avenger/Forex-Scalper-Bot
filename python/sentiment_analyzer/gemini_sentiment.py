...
"""
    ...
    def switch_model(self, new_model_name: str) -> bool:
        ...
        try:
            ...
            logger.info(f"Successfully switched sentiment analyzer from {old_model} to {new_model_name}")
            return True
            
        except Exception as e:
            logger.error(f"Failed to switch sentiment analyzer to model {new_model_name}: {e}")
            return False